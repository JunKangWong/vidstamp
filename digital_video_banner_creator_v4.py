...
# Load your video
video = VideoFileClip("/Users/junkangwong/Documents/github_repo/digital_card/input/sample_vid2.mp4")
...
text = text.set_duration(9).set_position("center")
